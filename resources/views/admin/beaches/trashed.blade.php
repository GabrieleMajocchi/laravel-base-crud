                    ...
                    <tbody>
                        @foreach ($beachList as $beach)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('admin.beaches.restore', $beach->id) }}"
                                        class="d-inline form-restorer" method="POST">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    <form action="{{ route('admin.beaches.hardDelete', $beach->id) }}"
        ...
        deleteFormElements.forEach(formElement => {
            formElement.addEventListener('submit', function(event) {
                ...
                const userConfirmDelete = window.confirm(
                    'Are you sure you want to delete permantly this beach?');
